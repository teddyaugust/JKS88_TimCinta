...
public class  MarketingPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //buka webnya
        webView = (WebView) findViewById(R.id.plan_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("http://jks88.flazhincinta.id/marketing-plan/");
