...
public class  UpdateNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = findViewById(R.id.adView_news);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        //buka webnya
        webView = (WebView) findViewById(R.id.infoterkini_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://www.flazhincinta.id/category/info-terbaru/");
